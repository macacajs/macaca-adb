...
ADB.prototype.startApp = function() {
  ...
  var shell = `am start -S -a android.intent.action.MAIN -c android.intent.category.LAUNCHER -f 0x10200000 -n ${options.package}/${options.activity}`;
